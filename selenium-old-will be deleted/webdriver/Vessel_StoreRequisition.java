...
public class Vessel_StoreRequisition {
    WebDriver driver;
    ...
    By StoreRequisitionMenu = By.xpath("//div[@class='flex-1']//div[text()='Requisition']/parent::div/parent::div/following-sibling::div//a[text()=\"Ship's Stores\"]");
    ...
    @Test
    public void TC_03_OpenStoreRequisitionPage() {
        //sleepInSecond(3);
        ...
        explicitWait.until(ExpectedConditions.elementToBeClickable(StoreRequisitionMenu));
        driver.findElement(StoreRequisitionMenu).click();
        explicitWait.until(ExpectedConditions.visibilityOfElementLocated(BreadcrumbTitle));
        Assert.assertEquals(driver.findElement(BreadcrumbTitleStore).getText(), "Ship's Stores");
    }
    By StoreSelectorButtonLocator = By.xpath("//span[text()='Store Selector']/parent::button");

    @Test
    public void TC_04_OpenStoreSelector() {
        //waitUntilInvisible(LoadingIcon);
        explicitWait.until(ExpectedConditions.elementToBeClickable(StoreSelectorButtonLocator));
        driver.findElement(StoreSelectorButtonLocator).click();
        waitUntilInvisible(LoadingIcon);
    }
    ...
    public void TC_05_SelectGroup() {
        selectedDropdownList("//div[contains(@class,'placeholder')]/span[text()='Group']",
    ...
    By M300015ItemCheckbox = By.xpath("//div[text()='3000010']/parent::div/parent::div/parent::td/preceding-sibling::td");
    By OK_Button_StoreSelector = By.xpath("//span[@class='el-dialog__title' and text()='Store Selector']/parent::header//following-sibling::footer//button/span[text()='OK']");
    By StoreSelectorPopup = By.xpath("//span[@class='el-dialog__title' and text()='Store Selector']");
    @Test
    public void TC_06_ItemIsSelected() {
        // check a checkbox
        WebElement element = driver.findElement(M300015ItemCheckbox);

        // Scroll to the element
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element);

        explicitWait.until(ExpectedConditions.visibilityOfElementLocated(M300015ItemCheckbox));
        element.click();

        // click on OK button
        driver.findElement(OK_Button_StoreSelector).click();
        ...
        waitUntilInvisible(StoreSelectorPopup);
    }
    By RequestColumnLocator =
            By.xpath("//td[contains(@class,'el-table_1_column_7')]//input");
    By SaveButtonLocator = By.xpath("//span[text()='Save']");
    @Test
    public void TC_07_InputRequest() {
    ...
    By NeedDateLocator = By.xpath("//div[text()=' Need Date ']/parent::td/following-sibling::td//input[@placeholder='Pick a date']");
    @Test
    public void TC_08_InputNeedDate() {
    ...
    By SubjectLocator = By.xpath("//td[text()=' Subject']/following-sibling::td[position()=1]//input");
    @Test
    public void TC_09_InputSubject() {

        driver.findElement(SubjectLocator).sendKeys("This is Subject");
    ...
    @Test
    public void TC_11_ClickOnSaveButton() {
    ...
    @Test
    public void TC_12_ClickOnSubmitButton_OpenSubmitPopup() {
        try {
            // Verify if element visible
            explicitWait.until(ExpectedConditions.visibilityOfElementLocated(SaveSuccessToast));
            if (driver.findElement(SaveSuccessToast).isDisplayed()) {
                System.out.println("TC_12_ClickOnSubmitButton_OpenSubmitPopup - SaveSuccessToast Element is visible. Waiting for it to become invisible...");
                // Wait for element invisible
                explicitWait.until(ExpectedConditions.invisibilityOfElementLocated(SaveSuccessToast));
                System.out.println("TC_12_ClickOnSubmitButton_OpenSubmitPopup - SaveSuccessToast Element Element is now invisible.");
            }
        } catch (Exception e) {
        ...
        String docNo = driver.findElement(By.xpath("//td[contains(text(),'Document No')]/following-sibling::td[position()=1]//input")).getAttribute("value");
        System.out.println("TC_12_ClickOnSubmitButton_OpenSubmitPopup - Doc No auto Approved: "+docNo);
